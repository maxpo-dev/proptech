    ...
    return (
      <div className="w-full px-4 py-24 text-center flex flex-col items-center">
        ...
        <article className="bg-white shadow-2xl rounded-lg p-6 w-full md:w-3/4 lg:w-2/3 text-center relative">
          <h2 className="text-2xl font-extrabold mb-4">Dubai – The PropTech Powerhouse Driving the Future of Real Estate</h2>

          <h3 className="text-xl font-extrabold mt-6 mb-3">Dubai: A Global Hub for PropTech Innovation</h3>
          ...
          <h3 className="text-xl font-extrabold mt-6 mb-3">Why is Dubai Leading the PropTech Revolution?</h3>
  
          <p className="text-gray-800 text-base font-semibold mb-4">
            <strong>1. AI and Smart Cities: The Future of Real Estate</strong><br />
          ...
          <p className="text-gray-800 text-base font-semibold mb-2">
            <strong>2. Blockchain-Powered Transactions: Secure and Hassle-Free</strong><br />
          ...
          <p className="text-gray-800 text-base font-semibold mt-4 mb-2">
            <strong>3. Fractional Ownership: Democratizing Real Estate Investments</strong><br />
          ...
          <p className="text-lg font-extrabold mt-4">Join the revolution and be part of Dubai’s digital real estate evolution!</p>
          <p className="text-base mt-1">Register at <a href="https://www.futureproptechsummit.com" className="text-blue-500 underline">Future PropTech Summit 2025</a>.</p>
