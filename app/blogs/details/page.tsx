...
export default function BlogDetailsPage() {
  return (
    <div className="w-full px-4 py-24 text-center flex flex-col items-center">
      {/* Full-width Image with 88% Viewport Height */}
      ...
      <article className="bg-white shadow-2xl rounded-lg p-6 w-full md:w-3/4 lg:w-2/3 text-center relative">
        ...
        <p className="text-gray-800 text-base font-semibold mb-4">
          <strong>Dubai’s Role in the Future of Real Estate:</strong> Dubai continues to lead as a global hub for real estate investments, leveraging AI and blockchain to drive the sector forward. Experts will discuss trends in the Dubai property market and how digital transformation is shaping the future of property investment.
        </p>
        ...
        <div className="w-full mt-6 relative aspect-[3/1.5]">
          <Image
