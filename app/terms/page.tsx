    ...
    <div className="bg-gray-50 min-h-screen py-20">
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">1. Use of the Website</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">2. Event Registration and Participation</h2>
          <ul className="list-decimal ml-6 text-gray-600 space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">3. Payment Terms</h2>
          <ul className="list-decimal ml-6 text-gray-600 space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">4. Cancellation and Substitution Policy</h2>
          <ul className="list-decimal ml-6 text-gray-600 space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">5. Event Changes and Force Majeure</h2>
          <ul className="list-decimal ml-6 text-gray-600 space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">7. Photography and Media Release</h2>
          <ul className="list-decimal ml-6 text-gray-600 space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">8. Privacy and Data Protection</h2>
          <ul className="list-decimal ml-6 text-gray-600 space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">9. Limitation of Liability</h2>
          <ul className="list-decimal ml-6 text-gray-600 space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">10. Indemnification</h2>
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">11. Governing Law and Jurisdiction</h2>
          <ul className="list-decimal ml-6 text-gray-600 space-y-2">
        ...
        <section className="mb-10">
          <h2 className="text-2xl font-semibold text-gray-700 mb-4">12. Modifications to Terms</h2>
          <ul className="list-decimal ml-6 text-gray-600 space-y-2">
