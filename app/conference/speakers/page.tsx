...
<SpeakerCard
          ...
          />
          <SpeakerCard name="Dr. Abdulla AlWahedi" jobTitle="Chief Executive Officer - Irtikaz Group" companyName="Irtikaz Group" linkedIn="https://www.linkedin.com/in/abdullaalwahedi?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" speakerImage="/image/speakers/Dr. Abdulla.jpg" companyLogo="/image/speakers/Logo.jpg" fullBio="Experienced Chief Executive Officer with a demonstrated history of working in the facilities management industry. Strong business development professional skilled in Operations Management, Facility Management (FM), Contract Management, and Business Development."          />
        </div>
      </div>
    </div>
  );
